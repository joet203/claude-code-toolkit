...
- **the user's taste** — when generating imagery, art-direct to his profile (`your taste profile (a notes file you maintain)`): cinematic/photoreal, painterly concept art, or retro-analog film grain; sci-fi-atmosphere and nature/documentary worlds; surreal twists, epic detail, dramatic light. Not flat vector. Append a dated note to that file when he reacts strongly to a page or image.
